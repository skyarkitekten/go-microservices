...
/** The CreateConsignment component */
class CreateConsignment extends React.Component {
  ...
  constructor(props) {
    ...
    /** Render for the ConsignmentComponent
     * @return {ConsignmentComponent} - the consignment component
     */
    render() {
        ...
        <div className='consignment-screen'>
          <div className='consignment-form container'>
            ...
            <div className='form-group'>
              <textarea onChange={this.setDescription}
                className='form-control' placeholder='Description'></textarea>
            </div>
            <div className='form-group'>
              <input onChange={this.setWeight} type='number'
